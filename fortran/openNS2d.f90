...
program shielded_vortex
	...
	real(kind=OCFD_REAL_KIND),parameter::M0=0.4d0,Mv=0.2d0,gama=1.4d0
	real(kind=OCFD_REAL_KIND),parameter::p0=1.d0/gama/M0**2.d0,rho0=1.d0,u0=1.d0
	...
	call part2d()	
	allocate(u(1-LAP:nx+LAP,1-LAP:ny+LAP),v(1-LAP:nx+LAP,1-LAP:ny+LAP))
	allocate(p(1-LAP:nx+LAP,1-LAP:ny+LAP),xx(1-LAP:nx+LAP,1-LAP:ny+LAP))
	allocate(yy(1-LAP:nx+LAP,1-LAP:ny+LAP),rho(1-LAP:nx+LAP,1-LAP:ny+LAP))
