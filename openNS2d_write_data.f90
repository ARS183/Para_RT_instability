	...
	real(kind=OCFD_REAL_KIND),allocatable,dimension(:,:) :: temp_rho,temp_u,temp_v,temp_p,temp_xx,temp_yy
	real(kind=OCFD_REAL_KIND),dimension(1:nx_global,1:ny_global) :: rho_global,u_global,v_global,p_global,xx_global,yy_global
